...
# 13 "./ECU_Layer/ecu_seven_seg/ecu_seven_seg.h"
# 1 "./ECU_Layer/ecu_seven_seg/ecu_seven_seg_cfg.h" 1
# 13 "./ECU_Layer/ecu_seven_seg/ecu_seven_seg.h" 2
# 23 "./ECU_Layer/ecu_seven_seg/ecu_seven_seg.h"
typedef enum {
...
# 1 "./ECU_Layer/button/../BUTTON/ecu_button_cfg.h" 1
...
void welcome_func (void) {
    ...
    ret = lcd_8bit_send_command(&lcd8bit, 0x18);
    _delay((unsigned long)((100)*(8000000UL/4000.0)));
    ret = lcd_8bit_send_command(&lcd8bit, 0x1C);
...
void loading_func (void) {
    ...
    for (int i = 0 ; i < 5 ; i++){
      ...
      _delay((unsigned long)((50)*(8000000UL/4000.0)));
        ...
        ret = lcd_8bit_send_command(&lcd8bit, 0X01);
        ret = lcd_8bit_send_command(&lcd8bit, 0x02);
