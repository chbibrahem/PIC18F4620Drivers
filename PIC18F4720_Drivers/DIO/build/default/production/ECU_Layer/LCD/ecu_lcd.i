...
static Std_ReturnType lcd_4bit_set_cursor(const chr_lcd_4bit_t *lcd , uint8_t row , uint8_t columns){
    ...
    columns --;
    switch (row){
        case 1: ret = lcd_4bit_send_command(lcd, (0x80+ columns)); break;
        case 2: ret = lcd_4bit_send_command(lcd, (0xC0+ columns)); break;
        case 3: ret = lcd_4bit_send_command(lcd, (0x94+ columns)); break;
        case 4: ret = lcd_4bit_send_command(lcd, (0xd4+ columns)); break;
        default : ;
    }
    return ret;
}
