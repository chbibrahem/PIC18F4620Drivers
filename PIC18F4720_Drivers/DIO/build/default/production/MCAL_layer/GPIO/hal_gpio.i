    ...
    if (((void*)0) == _pin_config || _pin_config-> pin > 8 -1) {
        ...
        switch (_pin_config->direction){
            case GPIO_DIRECTION_OUTPUT:
                (*tris_register[_pin_config->port] &= ~((uint8_t)1<<_pin_config->pin));
                break;
...
Std_ReturnType gpio_pin_get_direction_status(const pin_config_t * _pin_config , direction_t * direction_status){
    ...
    if (((void*)0) == _pin_config || ((void*)0) == direction_status || _pin_config-> pin > 8 -1) {
        ...
        *direction_status = ((*tris_register[_pin_config->port] >>_pin_config->pin) & (uint8_t)1);
...
Std_ReturnType gpio_pin_write_logic(const pin_config_t * _pin_config , logic_t logic){
    ...
    if (((void*)0) == _pin_config || _pin_config-> pin > 8 -1) {
        ...
        switch (logic){
            case GPIO_LOW:
                (*lat_register[_pin_config->port] &= ~((uint8_t)1<<_pin_config->pin));
                break;
            case GPIO_HIGH :
                (*lat_register[_pin_config->port] |= ((uint8_t)1<<_pin_config->pin));
                break;
...
Std_ReturnType gpio_pin_read_logic(const pin_config_t * _pin_config , logic_t *logic){
    ...
    if (((void*)0) == _pin_config || ((void*)0) == logic || _pin_config-> pin > 8 -1) {
        ...
        *logic = ((*port_register[_pin_config->port] >>_pin_config->pin) & (uint8_t)1);
    }
